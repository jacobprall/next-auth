...
export const GET_USER_BY_ROW_ID_SQL = `SELECT * FROM users WHERE rowid = ?`
...
export const GET_SESSION_BY_TOKEN_SQL = `SELECT * FROM sessions WHERE sessionToken = ?`
export const GET_SESSION_AND_USER_BY_TOKEN_SQL = `
